package com.github.mizzlr.halsteadmetrics.models;
...
public class Operands {
	...
	public void insert(String name){
		if(this.name.contains(name)){
			int count=Integer.parseInt(this.count.get(this.name.indexOf(name)).toString());
	...
	public void insert(String name,int counter){
		if(this.name.contains(name)){
			counter+=Integer.parseInt(this.count.get(this.name.indexOf(name)).toString());
